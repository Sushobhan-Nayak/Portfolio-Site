...
const TransititonProvider = ({ children }) => {
  ...
  return (
    <AnimatePresence mode="wait">
      <div className="w-screen h-screen bg-black" key={pathName}>
        <motion.div
        ...
        />
        <motion.div
          className="fixed m-auto top-0 bottom-0 left-0 right-0 text-black text-4xl md:text-6xl lg:text-7xl cursor-default w-fit h-fit z-50"
          initial={{ opacity: 1 }}
          animate={{ opacity: 0 }}
          exit={{ opacity: 0 }}
